...
public class EditUserTable extends CreateUserTable{
    ...
    public void insertRecord(String name, String pw, String ip) {
    ...
    public void updateRecord(String name, String pw) {
    ...
    public Cursor getAllRecords() {
        return database.query(TABLE_NAME, new String[] { KEY_NAME, KEY_PW},
    ...
    public Cursor getOneRecord(String name) {
        return database.query(TABLE_NAME, new String[] { KEY_NAME,
                        KEY_PW}, KEY_NAME + "=?", new String[]{ name }, null, null,
                null);
